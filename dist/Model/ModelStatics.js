...
class ModelStatics {
    ...
    static find(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield ModelStatics.knex.select().from(tableName).where('id', id).first();
            if (record == null) {
    ...
    static findBy(criteria) {
        return __awaiter(this, void 0, void 0, function* () {
            const _this = this;
            const tableName = ModelUtil.tableNameFromModel(_this);
            const record = yield ModelStatics.knex.select().from(tableName).where(criteria).first();
